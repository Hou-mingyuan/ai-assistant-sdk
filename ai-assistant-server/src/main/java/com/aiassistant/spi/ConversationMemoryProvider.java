...
/**
 * SPI for providing conversation memory instances.
 * Default implementation uses in-memory storage keyed by session ID.
 * Override to provide persistent (Redis, DB) storage.
 */
