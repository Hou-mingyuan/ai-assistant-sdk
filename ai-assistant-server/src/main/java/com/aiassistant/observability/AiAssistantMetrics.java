...
/**
 * Registers custom Micrometer gauges for the AI assistant.
 * Provides real-time metrics for observability dashboards (Prometheus, Grafana, etc.).
 */
public class AiAssistantMetrics {
    ...
    public AiAssistantMetrics(MeterRegistry registry,
        ...
        if (toolRegistry != null) {
            Gauge.builder("aiassistant.tools.count", toolRegistry,
        ...
        if (tokenUsageTracker != null) {
            Gauge.builder("aiassistant.tokens.total", tokenUsageTracker,
