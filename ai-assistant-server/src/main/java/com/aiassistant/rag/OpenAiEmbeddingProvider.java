...
/**
 * Calls the OpenAI-compatible /v1/embeddings endpoint. Works with OpenAI, Azure OpenAI, and
 * compatible providers (Ollama, vLLM, etc.).
 */
public class OpenAiEmbeddingProvider implements EmbeddingProvider {
    ...
    public OpenAiEmbeddingProvider(AiAssistantProperties properties) {
        ...
        this.dims =
                properties.getEmbeddingDimensions() > 0
        ...
        log.info(
                "OpenAiEmbeddingProvider initialized: model={}, dims={}, baseUrl={}",
                model,
                dims,
                baseUrl);
    }
        ...
        try {
            ...
            for (JsonNode item : data) {
                ...
                if (embeddingNode == null || !embeddingNode.isArray()) {
                    throw new RuntimeException(
                            "Embedding API returned invalid item: missing 'embedding' array");
                }
