...
public class AiAssistantAutoConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean
    public AssistantExportController assistantExportController(AiAssistantProperties assistantProperties) {
        return new AssistantExportController(assistantProperties);
    }
