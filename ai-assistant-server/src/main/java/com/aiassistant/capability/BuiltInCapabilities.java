...
public final class BuiltInCapabilities {
    ...
    public static AssistantCapability translate(LlmService llmService) {
        return new AssistantCapability() {
            ...
            public String description() {
                return "Translate text to a target language with natural, idiomatic output";
            }
                                ...
                                Map.of(
                                        ...
                                        "targetLang",
                                                Map.of(
                                                        ...
                                                        "string",
                                                        "description",
                                                        "Target language code (zh, en, ja, etc.)")));
            }
            ...
            public List<String> tags() {
                return List.of("translation", "language");
            }
        };
    }
    ...
    public static AssistantCapability summarize(LlmService llmService) {
        return new AssistantCapability() {
            ...
            @Override
            public String description() {
                return "Summarize text concisely, preserving key points";
            }
            ...
            @Override
            public List<String> tags() {
                return List.of("summarization", "content");
            }
        };
    }
    ...
    public static AssistantCapability chat(LlmService llmService) {
        return new AssistantCapability() {
            ...
            @Override
            public String description() {
                return "Have a conversation with the AI assistant";
            }
            ...
            public Map<String, Object> inputSchema() {
                return Map.of(
                        ...
                        "properties",
                                Map.of(
                                        "message",
                                        Map.of("type", "string", "description", "User message")));
            }
            ...
            @Override
            public List<String> tags() {
                return List.of("chat", "conversation");
            }
        };
    }
}
