 ...
 *
 * <p>Only a request exactly at the configured context path, or below it as a child path, is
 * considered in scope. This avoids treating paths such as {@code /ai-assistant2/chat} as if they
 * belonged to {@code /ai-assistant}.
 */
