...
/**
 * Immutable audit event capturing who did what and when in the AI assistant. Emitted by core
 * services; consumed by {@link AuditEventStore} implementations.
 */
public record AuditEvent(
    ...
    public static final class Builder {
        ...
        public Builder promptTokens(int v) {
            this.promptTokens = v;
            return this;
        }

        public Builder completionTokens(int v) {
