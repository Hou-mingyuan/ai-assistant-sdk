...
/**
 * SPI for role-based access control. Implement and register as a Spring Bean to enforce
 * per-tenant/per-user permissions. Default implementation allows all operations.
 */
