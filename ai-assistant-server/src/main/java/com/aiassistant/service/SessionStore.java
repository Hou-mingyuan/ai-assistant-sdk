...
/**
 * Session store abstraction. Implement this interface to back sessions with a database,
 * Redis, or any other storage. The default in-memory implementation is {@link InMemorySessionStore}.
 */
