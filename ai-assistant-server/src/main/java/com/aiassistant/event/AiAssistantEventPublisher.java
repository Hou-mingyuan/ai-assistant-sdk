...
/**
 * Facade for publishing AI assistant events. Wraps {@link ApplicationEventPublisher} with
...
public class AiAssistantEventPublisher {
    ...
    public void chatCompleted(
        ...
        publish(
                AiAssistantEvent.EventType.CHAT_COMPLETED,
                "chat",
                tenantId,
                modelId,
                sessionId,
    ...
    public void chatFailed(
            String tenantId, String modelId, String sessionId, long durationMs, String error) {
        publish(
                AiAssistantEvent.EventType.CHAT_FAILED,
                "chat",
                tenantId,
                modelId,
                sessionId,
    ...
    public void translateCompleted(String tenantId, String modelId, long durationMs) {
        publish(
                AiAssistantEvent.EventType.TRANSLATE_COMPLETED,
                "translate",
                tenantId,
                modelId,
                null,
    ...
    public void summarizeCompleted(String tenantId, String modelId, long durationMs) {
        publish(
                AiAssistantEvent.EventType.SUMMARIZE_COMPLETED,
                "summarize",
                tenantId,
                modelId,
                null,
    ...
    public void modelFallback(String failedModel, String fallbackModel, String reason) {
        publish(
                AiAssistantEvent.EventType.MODEL_FALLBACK,
                "fallback",
                null,
                fallbackModel,
                null,
    ...
    public void toolCalled(String toolName, long durationMs, boolean success) {
        publish(
                AiAssistantEvent.EventType.TOOL_CALLED,
                "tool",
                null,
                null,
                null,
    ...
    public void capabilityInvoked(String capabilityName, long durationMs, boolean success) {
        publish(
                AiAssistantEvent.EventType.CAPABILITY_INVOKED,
                "capability",
                null,
                null,
                null,
    ...
    private void publish(
            AiAssistantEvent.EventType type,
            String operation,
            String tenantId,
            String modelId,
            String sessionId,
