...
public class AssistantExportController {
    ...
    public AssistantExportController(AiAssistantProperties properties) {
        this.exportService = new AssistantExportService(properties);
    }
    ...
    /**
     * 同时提供 ASCII {@code filename} 与 RFC 5987 {@code filename*}，避免 Windows/Chrome
     * 把 RFC2047 风格编码误当成整段文件名（另存为出现 {@code =_UTF-8_Q_...}）。
     */
