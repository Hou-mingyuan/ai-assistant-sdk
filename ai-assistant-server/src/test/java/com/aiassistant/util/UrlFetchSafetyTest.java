...
class UrlFetchSafetyTest {
    ...
    void blocksLinkLocal() {
        assertThrows(
                ...
                () ->
                        UrlFetchSafety.validateHttpUrlForServerSideFetch(
                                URI.create("http://169.254.169.254/metadata")));
    }
    ...
    void blocksFtpScheme() {
        assertThrows(
                ...
                () ->
                        UrlFetchSafety.validateHttpUrlForServerSideFetch(
                                URI.create("ftp://files.example.com/")));
    }
    ...
    void blocksCgn() {
        assertThrows(
                ...
                () ->
                        UrlFetchSafety.validateHttpUrlForServerSideFetch(
                                URI.create("http://100.100.100.100/")));
    }
    ...
    void blocksMulticastAndReservedIpv4Ranges() {
        assertThrows(
                ...
                () ->
                        UrlFetchSafety.validateHttpUrlForServerSideFetch(
                                URI.create("http://224.0.0.1/")));
        assertThrows(
                IllegalArgumentException.class,
                () ->
                        UrlFetchSafety.validateHttpUrlForServerSideFetch(
                                URI.create("http://255.255.255.255/")));
    }
    ...
    void blocksDocumentationAndBenchmarkIpv4Ranges() {
        assertThrows(
                ...
                () ->
                        UrlFetchSafety.validateHttpUrlForServerSideFetch(
                                URI.create("http://192.0.2.1/")));
        assertThrows(
                IllegalArgumentException.class,
                () ->
                        UrlFetchSafety.validateHttpUrlForServerSideFetch(
                                URI.create("http://198.18.0.1/")));
        assertThrows(
                IllegalArgumentException.class,
                () ->
                        UrlFetchSafety.validateHttpUrlForServerSideFetch(
                                URI.create("http://203.0.113.1/")));
    }
    ...
    void blocksUnsafeIpv6Ranges() {
        ...
        assertThrows(
                ...
                () ->
                        UrlFetchSafety.validateHttpUrlForServerSideFetch(
                                URI.create("http://[::ffff:127.0.0.1]/")));
    }
}
