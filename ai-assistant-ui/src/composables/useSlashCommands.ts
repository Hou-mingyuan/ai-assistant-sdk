    ...
    return [
      {
        ...
        action: () => { opts.onClear(); return true; },
      },
      {
        name: '/new',
        description: opts.t.value.newSession || '新会话',
        icon: 'M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z',
        action: () => { opts.onNewSession(); return true; },
      },
      {
        name: '/translate',
