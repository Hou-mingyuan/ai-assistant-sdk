...
export const ko: I18nMessages = {
  ...
  streamStageSearchingWeb: '웹 검색 중…',
  ...
  responseMetaWebSearchReferences: '참고 출처',
  ...
  markdownBold: '굵게 (Ctrl+B)',
  markdownItalic: '기울임 (Ctrl+I)',
  markdownCode: '인라인 코드',
  markdownCodeBlock: '코드 블록',
  markdownLink: '링크',
  markdownList: '목록',
  emptyTaskLauncher: '예시 작업 보기',
  emptyTaskLauncherClose: '예시 작업 접기',
  emptyStarterSection: '추천 작업',
  emptyCapabilitySection: '기능 안내',
  emptyTemplateSection: '템플릿',
